                ...
                <div class="sub-environment__section-inner inner">
                    ...
                    <div class="sub-environment__stats-group">
                        ...
                        <div class="sub-environment__stats-num-image">
                            <picture class="">
                                <source srcset="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/all-pc.svg"
                                    media="(min-width: 768px)" />
                                <img src="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/all-sp.svg" alt="">
                            </picture>
                        </div>
                    </div>
                    ...
                    <div class="sub-environment__stats-group">
                        ...
                        <div class="sub-environment__stats-num-image">
                            <picture class="">
                                <source srcset="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/ma-pc.svg"
                                    media="(min-width: 768px)" />
                                <img src="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/ma-sp.svg" alt="">
                            </picture>
                        </div>
                    </div>
                    ...
                    <div class="sub-environment__stats-group">
                        ...
                        <div class="sub-environment__stats-num-image">
                            <picture class="">
                                <source srcset="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/ag-pc.svg"
                                    media="(min-width: 768px)" />
                                <img src="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/ag-sp.svg" alt="">
                            </picture>
                        </div>
                    </div>
                        ...
                        <div class="sub-environment__stats-num-image">
                            <picture class="">
                                <source srcset="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/ex-pc.svg"
                                    media="(min-width: 768px)" />
                                <img src="<?php echo get_template_directory_uri(); ?>/img/environment/new-num/ex-sp.svg" alt="">
                            </picture>
                        </div>
                    </div>
