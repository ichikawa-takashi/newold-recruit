...
<main class="sub-page">
        ...
        <div class="sub-page__layout sub-page__layout--environment inner">
                ...
                <nav class="sub-page__nav">
                    <ul class="sub-page__nav-list">
                        <li class="sub-page__nav-item">
                            <a class="sub-page__nav-link" href="#sec00">オフィス紹介</a>
                        </li>
                        <li class="sub-page__nav-item">
            ...
            <div class="sub-page__section-wrapper sub-environment__section-wrapper">
                <!-- オフィス紹介 -->
                <section class="sub-environment__section sub-environment__office" id="sec00">
                    <div class="sub-environment__section-inner inner">
                        <div class="sub-page__section-heading">
                            <h2 class="sub-page__section-title">オフィス紹介</h2>
                        </div>
                        <p class="sub-environment__office-lead">温故知新（NEWOLD）を体現する拠点</p>
                        <p class="sub-environment__office-desc">
                            本社がある表参道は、明治神宮へと続く由緒ある参道でありながら、国内外の最先端のビジネスやカルチャーが集まる場所です。<br>
                            本社を構える「原宿ピアザビル」は、1973年に竣工した歴史ある建物です。時を重ねた風格を残しながら、現代の企業活動を支える機能性を兼ね備えたこの空間は、社名「NEWOLD」に込めた温故知新の想いを体現する場所でもあります。<br>
                            私たちは、このオフィスから企業・人・地域の成長を実現し、新たな価値を創造し続けます。
                        </p>

                        <div class="sub-environment__office-body">
                            <div class="sub-environment__office-tabs" role="tablist">
                                <button type="button" class="sub-environment__office-tab is-active js-office-tab" data-office-tab="entrance" role="tab" aria-selected="true">エントランス</button>
                                <button type="button" class="sub-environment__office-tab js-office-tab" data-office-tab="office" role="tab" aria-selected="false">執務エリア</button>
                                <button type="button" class="sub-environment__office-tab js-office-tab" data-office-tab="guestroom" role="tab" aria-selected="false">会議室</button>
                            </div>

                            <div class="sub-environment__office-panels">
                                <div class="sub-environment__office-panel is-active js-office-panel" data-office-panel="entrance">
                                    <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/entrance01.jpg" alt="エントランス">
                                </div>

                                <div class="sub-environment__office-panel js-office-panel" data-office-panel="office">
                                    <div class="swiper sub-environment__office-swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/office01.jpg" alt="執務エリア">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/office02.jpg" alt="執務エリア">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/office03.jpg" alt="執務エリア">
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div class="sub-environment__office-panel js-office-panel" data-office-panel="guestroom">
                                    <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/guestroom01.jpg" alt="会議室">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="sub-environment__section sub-environment__training" id="sec02">
                    <div class="sub-environment__section-inner inner">
                        ...
                        <ol class="sub-environment__training-list">
                            ...
                            <li class="sub-environment__training-item">
                                <div class="sub-environment__training-marker">
                                    <span class="sub-environment__training-timing">入社1〜5か月</span>
                                </div>
                                <div class="sub-environment__training-content">
                                    <div class="sub-environment__training-block">
                    ...
                    <div class="sub-environment__section-inner inner">
                        ...
                        <ul class="sub-environment__welfare-list">
                            <li class="sub-environment__welfare-item">
                                ...
                                <p class="sub-environment__welfare-text">健康保険、厚生年金保険、雇用保険、労災保険を完備しています。</p>
                            </li>
                            <li class="sub-environment__welfare-item">
                            ...
                            <li class="sub-environment__welfare-item">
                                ...
                                <p class="sub-environment__welfare-text">結婚・出産祝金をはじめ、弔慰金や香典など、社員とご家族のライフイベントを支える慶弔見舞金制度を整えています。</p>
                            </li>
                            <li class="sub-environment__welfare-item">
                            ...
                            <li class="sub-environment__welfare-item">
                                ...
                                <p class="sub-environment__welfare-text">年1回の健康診断を実施し、該当者には人間ドック費用の一部を補助する制度も設けています。</p>
                            </li>
                        </ul>
                    </div>
                </section>
                ...
                <section class="sub-environment__section sub-environment__stats" id="sec04">
                    <div class="sub-environment__section-inner inner">
                        ...
                        <div class="sub-environment__stats-group">
                            ...
                            <ul class="sub-environment__stats-list sub-environment__stats-list--capital">
                                <li class="sub-environment__stats-item">
                                    <picture>
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-capital-01-sp.svg" alt="平均年齢32歳">
                                    </picture>
                                </li>
                                <li class="sub-environment__stats-item">
                                    <picture>
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-capital-02-sp.svg" alt="年齢割合">
                                    </picture>
                                </li>
                                <li class="sub-environment__stats-item">
                                    <picture>
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-capital-03-sp.svg" alt="男女比率7:3">
                                    </picture>
                                </li>
                                <li class="sub-environment__stats-item">
                                    <picture>
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-capital-04-sp.svg" alt="中途・新卒入社比率87%:13%">
                                    </picture>
                                </li>
                                <li class="sub-environment__stats-item sub-environment__stats-item--fullSp">
                                    <picture>
                                        <source media="(min-width: 768px)"
                                            srcset="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-capital-05-pc.svg">
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-capital-05-sp.svg" alt="職種の割合フロント職67%・ミドルバック職33%">
                                    </picture>
                                </li>
                                <li class="sub-environment__stats-item sub-environment__stats-item--wide">
                                    <picture>
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-capital-06-sp.svg" alt="出身業界の割合">
                                    </picture>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="sub-environment__stats-list sub-environment__stats-list--agent">
                                ...
                                <li class="sub-environment__stats-item">
                                    <picture>
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-agent-05.svg" alt="初成約までの期間1.4か月">
                                    </picture>
                                </li>
                                <li class="sub-environment__stats-item">
                                    <picture>
                            ...
                            <ul class="sub-environment__stats-list">
                                ...
                                <li class="sub-environment__stats-item">
                                    <picture>
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri()); ?>/img/environment/stat-exparts-02.svg" alt="プロジェクトの平均期間1.4か月">
                                    </picture>
                                </li>
                                <li class="sub-environment__stats-item">
                                    <picture>
                                ...
                                <li class="sub-environment__stats-item sub-environment__stats-item--threeHalf">
                                    <picture>
                                        <source media="(min-width: 768px)"
                                ...
                                <li class="sub-environment__stats-item sub-environment__stats-item sub-environment__stats-item--threeHalfSp">
                                    <picture>
                                        <source media="(min-width: 768px)"
