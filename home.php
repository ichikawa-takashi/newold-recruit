                        ...
                        <li class="people-card__item">
                            <a href="<?php the_permalink(); ?>" class="people-card__item-link right-up-button">
                                <div class="people-card__image">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo esc_url(get_theme_file_uri('/img/common/no-image.jpg')); ?>" alt="<?php echo esc_attr($p_img_alt); ?>" />
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="people-card__meta">
                                        <div class="people-card__info">
                                            <?php if (!empty($p_department)): ?>
                                                <p class="people-card__department"><?php echo nl2br(esc_html($p_department)); ?></p>
                                            <?php endif; ?>
