        ...
        <div class="sub-page__hero-inner inner">
            <nav class="breadcrumb pc" aria-label="パンくずリスト">
                ...
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="HOMEへ移動する" href="<?php echo esc_url(home_url('/')); ?>"
                        class="home">
                ...
                &gt;
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="<?php echo esc_attr($bc_blog_title); ?>へ移動する"
                        href="<?php echo esc_url($bc_blog_url); ?>">
        ...
        <div class="inner single-people__inner">
                ...
                <div class="single-people__sidebar-column">
                    <aside class="single-people__sidebar">
                        <div class="single-people__portrait-wrapper pc">
                            <div class="single-people__portrait">
                                ...
                                <img src="<?php echo esc_url($people_portrait['url']); ?>"
                            ...
                            <div class="single-people__sidebar-meta">
                                ...
                                <p class="single-people__sidebar-dept">
                                    <?php echo nl2br(esc_html($people_department)); ?>
                                </p>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="single-people__sidebar-cta">
                        ...
                        <div class="single-people__sidebar-cta-buttons">
                            <a href="https://hrmos.co/pages/newold/jobs/0000001" target="_blank"
                            ...
                            <a href="https://hrmos.co/pages/newold" target="_blank" rel="noopener noreferrer"
                        ...
                        <div class="single-people__qa-item">
                            <div class="single-people__qa-header">
                                <span class="single-people__qa-number">
                                    Q<span
                                        class="single-people__qa-num-digit"><?php echo esc_html($block['number']); ?></span>
                                </span>
            ...
            <div class="single-people__video">
                <div class="single-people__video-wrap" data-lenis-prevent>
                    <iframe class="single-people__video-iframe" src="<?php echo esc_url($embed_url); ?>" frameborder="0"
        ...
        <div class="single-people__others">
                    ...
                    <div class="people-others__head">
                        ...
                        <div class="people-others__nav">
                            <button class="people-others__btn people-others__btn--prev" type="button"
                                aria-label="前の社員を見る">
                                <img src="<?php echo esc_url(get_theme_file_uri('/img/common/link-arrow-white.svg')); ?>"
                                    alt="" />
                            </button>
                            ...
                            <li class="swiper-slide people-others__item">
                                <a href="<?php the_permalink(); ?>" class="people-others__item-link right-up-button">
                                    <div class="people-others__image">
                                        ...
                                        <img src="<?php echo esc_url($o_portrait['url']); ?>"
                                            alt="<?php echo esc_attr($o_alt); ?>" />
                                        ...
                                        <img src="<?php echo esc_url(get_theme_file_uri('/img/common/no-image.jpg')); ?>"
                                            alt="<?php echo get_the_title(); ?> プロフィール写真" />
                                        <?php endif; ?>
                                    </div>
                                    <div class="people-others__content">
                                        <div class="people-others__profile-name">
                                            <p class="people-others__name-ja"><?php echo esc_html(get_the_title()); ?>
                                            </p>
            ...
            <div class="single-people__link link">
                <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts')) ?: home_url('/')); ?>"
                    class="single-people__link-anchor link__anchor">
                    <div class="link__icon">
                        <span class="image01">
                            <img src="<?php echo esc_url(get_theme_file_uri('/img/common/link-arrow-white.svg')); ?>"
                                alt="左向き矢印アイコン" loading="lazy" />
                        </span>
                        <span class="image02">
                            <img src="<?php echo esc_url(get_theme_file_uri('/img/common/link-arrow-white.svg')); ?>"
                                alt="左向き矢印アイコン" loading="lazy" />
